...
const Footer = () => {
  ...
  return (
    <footer>
      ...
      <p>
        &copy; {currentYear} <strong>Eigo</strong> - Online Shopping Store - Designed by Kadeejath Salaha @codestudy4 <a href="https://www.instagram.com/code_study4/" target="_blank">
      <FontAwesomeIcon icon={faInstagram} /> Instagram
        </a>
        <span> / </span>
        <a
